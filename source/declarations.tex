...
\tcode{template \grammarterm{splice-specialization-specifier}} and
...
\item otherwise, if $E$ is of the form
\tcode{template \grammarterm{splice-specifier}}, or
of the form \tcode{template \grammarterm{splice-specialization-specifier}}
whose \grammarterm{splice-specifier} designates a function template,
$E$ denotes an overload set\iref{expr.prim.splice} and
the program is ill-formed;
